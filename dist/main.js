...
const getWeeklyForecast = async () => {
  const res = await fetch("http://api.weatherapi.com/v1/forecast.json?key=0804b0f642fd40ccb16202934232209&days=7&q=mendoza");
  const json = await res.json();
  console.log(json.forecast.forecastday);
};
const getDailyForecast = async () => {
  const response = await fetch("http://api.weatherapi.com/v1/forecast.json?key=0804b0f642fd40ccb16202934232209&q=mendoza");
...
}`, "",{"version":3,"sources":["webpack://./src/styles/style.css"],"names":[],"mappings":"AAAA;IACI,uBAAuB;IACvB,kBAAkB;IAClB,sBAAsB;IACtB,kBAAkB;AACtB;AACA;;;IAGI,UAAU;IACV,SAAS;IACT,sBAAsB;AAC1B","sourcesContent":[":root{\n    font-family: sans-serif;\n    --main-color: #fff;\n    --secondary-color:#fff;\n    --acent-color:#fff;\n} \n*,\n::after,\n::before{\n    padding: 0;\n    margin: 0;\n    box-sizing: border-box;\n}"],"sourceRoot":""}]);
// Exports
...
const initApp = () => {
  (0,_modules_getData_js__WEBPACK_IMPORTED_MODULE_1__.getWeeklyForecast)();
  (0,_modules_getData_js__WEBPACK_IMPORTED_MODULE_1__.getDailyForecast)();
  // getActualWeather()
};
